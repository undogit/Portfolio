...
<div class="container">
            ...
            <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        ...
                        <h4 class="timeline-title">Technicien Environnement sur le site FBFC</h4>
            ...
            <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                    <div class="timeline-heading">
                        ...
                        <h4 class="timeline-title">Assistant Méthode HSE (Hygiène Sécurité Environnement) sur le site
                            FBFC</h4>
    ...
    <section id="realisation" class="row orange_box_up">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="item">
                <a href="#modal1"><img class="center-block img-responsive img-thumbnail"
                                       src="./image/screen_handiworld.png" height="250px" width="450px"></a>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="item">
                <a href="#modal2"><img class="center-block img-responsive" src="./image/screen_ex_dream.png"
                                       width="450px"></a>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="item">
                <a href="#modal3"><img class="center-block img-responsive" src="./image/integration_boostrap.png"
                                       width="450px"></a>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="item">
                <a href="#modal4"><img class="center-block img-responsive" src="./image/UnivacA.jpg"
                                       width="450px"></a>
    ...
    <div class="container">
        ...
        <div class="col-lg-4 col-md-4 col-xs-12 col-sm-12">
            <ul class="list-unstyled">
                ...
                <li><i class="fa fa-mobile"></i><span id="phone"><!-- TODO image phone --></span></li>
                <li><i class="fa fa-envelope"></i><span id="mail"><!-- TODO image mail --></span>
                ...
                <a target="_blank" href="https://fr.linkedin.com/pub/perrier-guillaume/108/192/a04">CV Couleur</a></li>
                <li><i class="cv_color fa fa-file-pdf-o"></i>
                <a target="_blank" href="https://fr.linkedin.com/pub/perrier-guillaume/108/192/a04">CV N&B</a></li>
            </ul>
...
<footer class="row">
    ...
    <div class="col-sm-12 col-xs-12 col-lg-4 col-md-4">
        <div class="social text-center">
            <a target="_blank" href="https://www.facebook.com/GuillaumeERRIPER"><i class="fa fa-facebook-official"></i></a>
            <a target="_blank" href="https://fr.linkedin.com/pub/perrier-guillaume/108/192/a04"><i
